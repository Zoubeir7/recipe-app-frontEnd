...
<template>
  <div class="container mt-5">
    <h1 class="mb-4 text-center fw-bold text-warning">Ajouter une catégorie</h1>
    ...
    <div class="p-4 bg-light rounded shadow-sm">
      <div class="input-group mb-4">
        ...
        <input type="text" class="form-control" placeholder="Nom de la catégorie" v-model="newCategory.name" />
      </div>
